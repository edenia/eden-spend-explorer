CREATE OR REPLACE VIEW "public"."transaction_by_category_and_election" AS 
 SELECT eden_election.election,
  ...
  GROUP BY eden_transaction.recipient, eden_transaction.category, eden_election.election, eden_transaction.type, eden_delegates.account, eden_election.delegate_level
  ORDER BY eden_election.election, eden_election.delegate_level;
